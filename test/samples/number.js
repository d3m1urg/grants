 ...
 */
var min = function min(value, minValue) {
 ...
 */
var max = function max(value, maxValue) {
 ...
 */
var precision = function precision(value, prec) {
  return String(value).search(new RegExp('^[0-9]+.([0-9]{' + prec + '})$')) >= 0;
};
